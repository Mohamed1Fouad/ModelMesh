...
export async function registerAgentRoutes(fastify: FastifyInstance) {
  ...
  // List agents
  scoped.get("/v1/agents", { preHandler: requirePermission("agent:read") }, async (_request: AuthenticatedRequest, reply) => {
  ...
  // Get agent details
  scoped.get("/v1/agents/:id", { preHandler: requirePermission("agent:read") }, async (request: AuthenticatedRequest, reply) => {
  ...
  // Execute agent
  scoped.post("/v1/agents/:id/execute", { preHandler: requirePermission("agent:write") }, async (request: AuthenticatedRequest, reply) => {
    const { id } = request.params as { id: string };
  ...
  // List agent sessions
  scoped.get("/v1/agents/:id/sessions", { preHandler: requirePermission("agent:read") }, async (request: AuthenticatedRequest, reply) => {
    const { id } = request.params as { id: string };
  ...
  scoped.get("/v1/agents/sessions/:sessionId/messages", { preHandler: requirePermission("agent:read") }, async (request: AuthenticatedRequest, reply) => {
  ...
  // List workflows
  scoped.get("/v1/workflows", { preHandler: requirePermission("workflow:read") }, async (_request: AuthenticatedRequest, reply) => {
  ...
  // Get workflow
  scoped.get("/v1/workflows/:id", { preHandler: requirePermission("workflow:read") }, async (request: AuthenticatedRequest, reply) => {
    const { id } = request.params as { id: string };
  ...
  // Execute workflow
  scoped.post("/v1/workflows/:id/execute", { preHandler: requirePermission("workflow:write") }, async (request: AuthenticatedRequest, reply) => {
    const { id } = request.params as { id: string };
  ...
  scoped.get("/v1/workflows/:id/executions", { preHandler: requirePermission("workflow:read") }, async (request: AuthenticatedRequest, reply) => {
    const { id } = request.params as { id: string };
  ...
  // Memory: Add
  scoped.post("/v1/agents/:id/memory", { preHandler: requirePermission("agent:write") }, async (request: AuthenticatedRequest, reply) => {
    const { id } = request.params as { id: string };
    const body = request.body as {
  ...
  // Memory: Query
  scoped.get("/v1/agents/:id/memory", { preHandler: requirePermission("agent:read") }, async (request: AuthenticatedRequest, reply) => {
    const { id } = request.params as { id: string };
  ...
  // Tools: List
  scoped.get("/v1/tools", { preHandler: requirePermission("agent:read") }, async (_request: AuthenticatedRequest, reply) => {
  ...
  scoped.post("/v1/tools/:name/execute", { preHandler: requirePermission("agent:write") }, async (request: AuthenticatedRequest, reply) => {
